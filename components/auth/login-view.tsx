...
export function LoginView() {
  ...
  const [email, setEmail] = useState('admin@buildcorp.global');
        ...
        <div className="lg:col-span-7 bg-white rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/60 p-6 sm:p-8 space-y-6">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-500">
              Select your role category or enter your project supervisor credentials.
            </p>
          </div>
          ...
          <div className="p-3.5 rounded-2xl bg-blue-50/70 border border-blue-100 text-xs space-y-1">
            ...
            <p className="text-[11px] text-slate-600">
              Email: <strong className="font-mono text-slate-800">admin@buildcorp.global</strong> • Password: <strong className="font-mono text-slate-800">admin123</strong>
            </p>
            <p className="text-[10px] text-slate-500 pt-0.5">
              Project Supervisors sign in with the credentials generated by the Super Admin during project setup.
            </p>
          </div>
